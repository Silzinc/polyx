  ...
  T: One + Zero + PartialEq + Clone,
{
  ...
  {
    self.degree() == 1 && self[1] == T::one() && self[0] == T::zero()
  }
}

impl<T> Polynomial<T>
where
  T: Zero + Mul<T, Output = T> + Add<T, Output = T> + Clone,
{
