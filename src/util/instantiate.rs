...
where
  T: Clone + Zero + Debug + One + Sub<Output = T> + HasNorm,
{
  #[inline]
  fn one() -> Self
  {
  ...
  T: Zero + Clone + HasNorm,
{
  ...
  {
    Polynomial::from(Vec::from_iter(iter))
  }
}
